    ...
    >
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-xs font-bold uppercase tracking-widest text-gray-400">
          <a href="#" className="hover:text-brand-lime transition-colors">Metodologia</a>
          <a href="#" className="hover:text-brand-lime transition-colors">Resultados</a>
          <a href="#" className="hover:text-brand-lime transition-colors">FAQ</a>
        </div>
